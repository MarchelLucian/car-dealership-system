...
function changePageSize() {
  ...
  window.location.href =
    `/agent-dashboard/cars-management/car-inventory?page=1&pageSize=` + size;
}
...
document
  ...
  .addEventListener("input", function () {
    ...
    fetch(
      `/agent-dashboard/cars-management/car-inventory/search-model?query=` +
        query,
    )
      .then((res) => res.json())
      .then((data) => {
...
document
  ...
  .addEventListener("input", function () {
    ...
    fetch(
      `/agent-dashboard/cars-management/car-inventory/search-vin?query=` +
        query,
    )
      .then((res) => res.json())
      .then((data) => {
